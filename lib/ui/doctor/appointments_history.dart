...
import 'package:pcare/api/doctor/appointments_history.dart';
...
class _AppointmentsHistoryState extends State<AppointmentsHistory> {
  ...
  void _callApi() {
    AppointmentsHistoryApi _appointmentsHistoryApi = AppointmentsHistoryApi();

    try {
      _upcomingAppointmentModelFuture =
          _appointmentsHistoryApi.getAppointmentsHistory();
    } catch (error) {
      print("Error " + error);
    }
  }
